...
> = {
  ...
  seeker: {
    ...
    emoji: "🔭",
    description:
      "今のあなたは、目の前のことをじっくり掘り下げたい気分。表面的な情報では物足りない今だからこそ、気になったことに時間をかけて向き合ってみると、思わぬ発見に出会えるはずです。",
  },
  harmonizer: {
    label: "調和者",
    emoji: "🤝",
    description:
      "今のあなたは、誰かと気持ちを分かち合いたい気分。周りの人と支え合うことで物事がうまく運びやすい今だからこそ、素直な一言を伝えてみると、思いがけない助けやつながりが生まれるはずです。",
  },
  guardian: {
    label: "守護者",
    emoji: "🛡️",
...
export const GODS: God[] = [
  {
    ...
    deepDive:
      "人からどう見られるかよりも、自分がまだ誰も足を踏み入れていない場所に辿り着けているかどうかを大切にします。同じ日々が続くと心のどこかで物足りなさを感じはじめ、無意識のうちに新しい刺激を探しにいくでしょう。挑戦している最中は多少のつまずきも気にならず、むしろ「まだ試していないやり方」を探すことに夢中になれるタイプです。慎重になりすぎて動けなくなるくらいなら、多少雑でも一歩踏み出した方が、結果的に多くを学べます。誰かに背中を押されるのを待つよりも、自分で扉を開けたときの方が、ずっと納得のいく結果に辿り着けるでしょう。停滞している時間が長く続くと、心の中に小さな苛立ちが溜まっていくので、定期的に新しい目標や刺激を自分に与えてあげることが、機嫌よく過ごすための秘訣です。頑張っている自分を誰かに認めてもらうことよりも、自分自身が「今日も一歩進めた」と実感できるかどうかを大切にしています。人と比べて落ち込むよりも、昨日の自分と比べて何が変わったかに目を向けると、着実に前進している自分に気づけるはずです。迷ったときは、頭より先に体を動かすことで答えが見えてくるタイプです。じっとしている時間が長いほど、かえって迷いは深まっていきます。",
    relationshipDeepDive:
      "人間関係においても、駆け引きよりストレートなやりとりを好みます。回りくどい言い方をされるより、多少ぶつかってでも本音で話してくれる相手を信頼しやすいタイプです。自分から誘ったり声をかけたりすることに抵抗がないので、新しい出会いの場でも物怖じせずに輪の中心になれるでしょう。ただし勢いのまま踏み込みすぎて、相手のペースを置き去りにしてしまうこともあるので、時には相手が今どんな気持ちでいるかを確かめる一呼吸も大切です。衝突が起きても、根に持たずすぐに切り替えられるさっぱりとした一面もあります。ただし勢いで言ってしまった言葉は、後からフォローの一言を添えると関係がより長続きします。それでも根っこの部分では誰よりも人懐っこく、一度仲良くなった相手のことは長く大切にし続けます。連絡の頻度が少なくても、気持ちが離れているわけではないと知っておいてもらえると安心です。褒められることよりも、一緒に何かに挑戦してくれる相手にこそ、心からの信頼を寄せるようになります。",
    ...
    illustrations: [
      ...
      "/gods/illustrations/gyoutenshin-06-closing.png",
    ],
  },
  {
    name: "疾風神",
    ...
    illustrations: [
      ...
      "/gods/illustrations/shippuushin-06-closing.png",
    ],
  },
  {
    name: "大地神",
    ...
    deepDive:
      "派手な変化を求めるよりも、日々の小さな積み重ねの中に確かな手応えを感じるタイプです。急かされるとかえって本来の力を発揮できず、自分のペースを守れているときにこそ、周囲が驚くほどの粘り強さを見せます。裏切らない努力の積み重ねが、いつの間にか誰にも真似できない土台を築いていくでしょう。結果がすぐに出なくても焦る必要はありません。地道な歩みそのものが、あなたにとって一番信頼できる武器になっていきます。目に見える成果が出るまでに時間がかかっても、途中で投げ出さない粘り強さは誰にも真似できません。周囲が焦っている時ほど、あなたの落ち着いた対応が場を安定させる力になります。ただし自分の中で「こうあるべき」という基準が強くなりすぎると、柔軟な対応が必要な場面で身動きが取りにくくなることもあるため、時には流れに身を任せる余裕も持っておきたいところです。周囲が目まぐるしく変化していく中でも、あなたが変わらずそこにいてくれるというだけで、多くの人が安心感を得ています。無理に自分を変えようとせず、今のペースを保ちながら、少しずつ新しいことを取り入れる工夫をすると、安定感を保ったまま成長を続けられるでしょう。急な変更や予定外の出来事にも、時間をかければきちんと対応できる柔軟さを内側に持っています。",
    relationshipDeepDive:
      "人間関係では、多くを語らずとも変わらない態度で接し続けることで、深い信頼を築いていくタイプです。派手なアプローチはしなくても、困ったときにそっと手を差し伸べてくれる存在として頼りにされることが多いでしょう。時間をかけて築いた関係ほど長続きしやすく、一度心を許した相手には驚くほど誠実に向き合います。ただし変化を嫌うあまり、関係の見直しが必要な場面でも動きが遅れがちなので、時には自分から一歩踏み出す勇気も大切です。相手の変化にすぐには気づけないこともありますが、一度気にかけると決めた相手には長く継続的な愛情を注ぎます。関係が長くなるほど当たり前になってしまいがちなので、節目節目で感謝の言葉を伝えることを忘れずにいると、関係はより強固なものになるでしょう。感情表現は控えめでも、行動の端々に思いやりが表れるタイプです。言葉で気持ちを伝えるのが苦手なら、態度や行動で示し続けることを大切にしてください。それがいずれ、何よりの安心材料として相手に届いていきます。",
    ...
    illustrations: [
      ...
      "/gods/illustrations/daichishin-06-closing.png",
    ],
  },
  {
    name: "清流神",
    ...
    illustrations: [
      ...
      "/gods/illustrations/seiryuushin-06-closing.png",
    ],
  },
  {
    name: "灯火神",
    ...
    illustrations: [
      ...
      "/gods/illustrations/toukashin-06-closing.png",
    ],
  },
  {
    name: "深緑神",
    ...
    illustrations: [
      ...
      "/gods/illustrations/shinryokushin-06-closing.png",
    ],
  },
  {
    name: "満月神",
    ...
    illustrations: [
      ...
      "/gods/illustrations/mangetsushin-05-lead.png",
      "/gods/illustrations/mangetsushin-06-closing.png",
    ],
  },
  {
    name: "黄金神",
    ...
    deepDive:
      "現状維持よりも、常に次の目標を見据えて動き続けることにやりがいを感じるタイプです。結果が数字や形になって見えるほど、あなたの中のエネルギーは大きく燃え上がります。負けず嫌いな一面が原動力になる一方で、結果だけにとらわれすぎると、そこに至る過程の充実感を見落としてしまうことも。時には歩みそのものを味わう余裕を持つと、より長く輝き続けられるでしょう。目標に向かっているときのあなたは、誰よりも生き生きとしたエネルギーを放ちます。逆に目指すものが見つからない時期は、どこか力が入らず物足りなさを感じてしまうかもしれません。そんな時こそ、小さくてもいいので「次に超えたい基準」を自分の中に設定してみると、再びエンジンがかかっていくでしょう。何かを達成したときの高揚感は、あなたにとって何よりのご褒美です。ただしその高揚感が長く続かないことに気づき始めると、次から次へと目標を追い続けることに疲れを感じる瞬間もあるでしょう。時には「なぜそれを目指しているのか」という原点に立ち返ることで、燃え尽きることなく走り続けられるはずです。目標に向かって走っているときのあなたは誰よりも輝いていますが、休むこともまた次の勝利への準備だと考えてみてください。小さな勝利を積み重ねることも、大きな目標へたどり着くための確かな一歩になります。",
    relationshipDeepDive:
    ...
    illustrations: [
      ...
      "/gods/illustrations/ougonshin-06-closing.png",
    ],
  },
  {
    name: "白銀神",
    ...
    illustrations: [
      ...
      "/gods/illustrations/hakuginshin-06-closing.png",
    ],
  },
  {
    name: "蒼穹神",
  ...
  },
  {
    ...
    illustrations: [
      ...
      "/gods/illustrations/seijakushin-06-closing.png",
    ],
  },
  {
    name: "陽炎神",
    ...
    illustrations: [
      ...
      "/gods/illustrations/kageroushin-05-lead.png",
      "/gods/illustrations/kageroushin-06-closing.png",
    ],
  },
];
